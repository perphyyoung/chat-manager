...
| `--z-overlay` | 9000 | 全局全屏遮罩 | 搜索/标签/回收站/确认/通知/右键/下拉遮罩及其面板体 |
...
| `--z-overlay` | SearchModal / TagSelector / RecycleBinModal / DropdownMenu / ContextMenu / ConfirmDialog / NotificationModal / TagFilter | 全屏遮罩及面板体（面板体为遮罩子元素；TagFilter 独立浮层直接用此层级） |
